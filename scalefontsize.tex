...
The syntax \meta{number} has the same meaning as the argument to \cs{fpeval},
which is documented in \pkg{usrguide}.

\begin{code}{\scalefontsize}
  \begin{syntax}
    \cs{scalefontsize} \marg{number}
  \end{syntax}
  Scales the font size and font baselineskip by factor \meta{number}.
